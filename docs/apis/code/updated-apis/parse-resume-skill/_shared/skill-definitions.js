/**
 * Shared Skill Definitions for GCP Cloud Function
 * 
 ...
 * 
 * Used by:
 * - parse-resume-skill (GCP)
 * - Any future GCP skill parsing functions
 * 
 * Mirrors: supabase/functions/_shared/skill-definitions.ts (Supabase version)
 * 
 ...
 */
function buildSkillCategorizationPrompt(includeCulture = true) {
 ...
 */
function getSoftSkillsString() {
  return SOFT_SKILLS_KEYWORDS.join(', ');
}

// CommonJS exports for GCP Cloud Function
module.exports = {
  SOFT_SKILLS_KEYWORDS,
  PROFICIENCY_LEVEL_CRITERIA,
  SKILL_TYPE_CATEGORIES,
  buildSkillCategorizationPrompt,
  getSoftSkillsString
};