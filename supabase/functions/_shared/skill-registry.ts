...
export const SOFTWARE_SKILLS_REGISTRY: SkillRelationship[] = [
  ...
  {
    skill: 'Python',
    children: ['Django', 'Flask', 'FastAPI', 'Pandas', 'NumPy', 'Scikit-learn', 'TensorFlow', 'PyTorch'],
    aliases: ['Python3', 'Python 3', 'py', 'Python 2.7', 'Python 3.x'],
    qualifiesFor: ['Backend Development', 'Data Science', 'Machine Learning', 'Scripting', 'Automation']
  },
  {
    skill: 'JavaScript',
    children: ['React', 'Vue', 'Angular', 'Node.js', 'Express', 'Next.js', 'TypeScript', 'jQuery'],
    aliases: ['JS', 'ECMAScript', 'ES6', 'ES2015', 'Javascript'],
    qualifiesFor: ['Frontend Development', 'Backend Development', 'Full Stack Development']
  },
  {
    skill: 'Java',
    children: ['Spring', 'Spring Boot', 'Hibernate', 'JPA', 'Maven', 'Gradle'],
    aliases: ['Java SE', 'Java EE', 'Jakarta EE', 'J2EE'],
    qualifiesFor: ['Backend Development', 'Enterprise Development', 'Android Development']
  },
  {
    skill: 'TypeScript',
    parent: ['JavaScript'],
    ...
    requires: ['JavaScript'],
    qualifiesFor: ['Frontend Development', 'Backend Development', 'Type-safe Development']
  },
  
  // Python Frameworks
  {
    skill: 'Django',
    parent: ['Python', 'Web Development', 'Backend Development'],
    requires: ['Python'],
  ...
  {
    skill: 'Flask',
    parent: ['Python', 'Web Development'],
    requires: ['Python'],
    aliases: ['Flask-RESTful', 'Flask API'],
    qualifiesFor: ['Backend Development', 'API Development', 'Microservices']
  },
  {
    skill: 'FastAPI',
    parent: ['Python', 'Web Development'],
    ...
    qualifiesFor: ['Backend Development', 'API Development', 'Async Programming']
  },
  ...
  },
  {
    ...
    requires: ['JavaScript', 'HTML', 'CSS'],
    children: ['Nuxt.js'],
    aliases: ['VueJS', 'Vue.js', 'Vue 3', 'Vue 2'],
    qualifiesFor: ['Frontend Development', 'SPA Development', 'UI Development']
  },
  {
    skill: 'Angular',
    parent: ['TypeScript', 'Frontend Development'],
    requires: ['TypeScript', 'JavaScript', 'HTML', 'CSS'],
    aliases: ['AngularJS', 'Angular 2+', 'Angular.js'],
    qualifiesFor: ['Frontend Development', 'SPA Development', 'Enterprise Frontend']
  },
  {
    skill: 'Node.js',
    parent: ['JavaScript', 'Backend Development'],
    children: ['Express', 'NestJS', 'Koa'],
    aliases: ['NodeJS', 'Node', 'Node JS'],
    qualifiesFor: ['Backend Development', 'API Development', 'Server-side JavaScript']
  },
  {
    skill: 'Next.js',
    parent: ['React', 'JavaScript'],
    requires: ['React', 'JavaScript'],
    aliases: ['NextJS', 'Next', 'Nextjs'],
    qualifiesFor: ['Full Stack Development', 'SSR', 'Frontend Development']
  },
  
  // Java Frameworks
  {
    skill: 'Spring',
    parent: ['Java', 'Backend Development'],
    requires: ['Java'],
    children: ['Spring Boot', 'Spring Cloud', 'Spring Security'],
    aliases: ['Spring Framework'],
    qualifiesFor: ['Backend Development', 'Enterprise Development', 'Microservices']
  },
  {
    skill: 'Spring Boot',
    parent: ['Spring', 'Java'],
    requires: ['Java', 'Spring'],
  ...
  // Databases
  {
    ...
    aliases: ['Postgres', 'PostGIS', 'PgSQL', 'PostgresSQL'],
    qualifiesFor: ['Database Management', 'Backend Development', 'Data Engineering']
  },
  {
    skill: 'MySQL',
    parent: ['SQL', 'Databases'],
    aliases: ['My SQL', 'MariaDB'],
    qualifiesFor: ['Database Management', 'Backend Development']
  },
  {
    skill: 'MongoDB',
    parent: ['NoSQL', 'Databases'],
    aliases: ['Mongo', 'Mongo DB'],
    qualifiesFor: ['NoSQL Database', 'Backend Development', 'Document Database']
  },
  {
    skill: 'Redis',
    parent: ['NoSQL', 'Databases', 'Caching'],
    aliases: ['Redis Cache', 'Redis DB'],
    qualifiesFor: ['Caching', 'Session Management', 'Message Queue']
  },
  ...
  // Cloud Platforms
  {
    ...
    children: ['EC2', 'S3', 'Lambda', 'RDS', 'DynamoDB', 'CloudFormation', 'ECS', 'EKS'],
    aliases: ['Amazon Web Services', 'Amazon AWS'],
    qualifiesFor: ['Cloud Computing', 'DevOps', 'Infrastructure', 'Cloud Architecture']
  },
  {
    skill: 'Azure',
    parent: ['Cloud Computing', 'DevOps'],
    children: ['Azure Functions', 'Azure DevOps', 'Azure Storage', 'Azure SQL'],
  ...
  },
  {
    skill: 'Google Cloud',
    parent: ['Cloud Computing', 'DevOps'],
    children: ['GCE', 'Cloud Functions', 'BigQuery', 'Cloud Storage'],
    aliases: ['GCP', 'Google Cloud Platform', 'GCloud'],
    qualifiesFor: ['Cloud Computing', 'DevOps', 'Infrastructure']
  },
  ...
  {
    skill: 'Docker',
    parent: ['DevOps', 'Containerization'],
    aliases: ['docker-compose', 'Docker Compose'],
    qualifiesFor: ['DevOps', 'Containerization', 'Microservices']
  },
  {
    skill: 'Kubernetes',
    parent: ['DevOps', 'Container Orchestration'],
    requires: ['Docker'],
    aliases: ['K8s', 'K8', 'Kube'],
    qualifiesFor: ['DevOps', 'Container Orchestration', 'Cloud Native']
  },
  {
    skill: 'Git',
    ...
    aliases: ['git', 'GIT'],
    qualifiesFor: ['Version Control', 'Source Control', 'Collaboration']
  },
  ...
  // High-level Categories
  {
    ...
    aliases: ['Front-end Development', 'Client-side Development', 'UI Development'],
    qualifiesFor: ['Web Development', 'Full Stack Development']
  },
  {
    skill: 'Backend Development',
    children: ['Node.js', 'Python', 'Java', 'C#', 'Ruby', 'PHP', 'Go'],
    aliases: ['Back-end Development', 'Server-side Development'],
    qualifiesFor: ['Web Development', 'Full Stack Development', 'API Development']
  },
  {
    skill: 'Full Stack Development',
    requires: ['Frontend Development', 'Backend Development'],
    aliases: ['Fullstack Development', 'Full-Stack Development'],
    qualifiesFor: ['Web Development', 'Software Development']
  },
  {
    skill: 'Cloud Computing',
    children: ['AWS', 'Azure', 'Google Cloud', 'Cloud Architecture'],
    aliases: ['Cloud Technologies', 'Cloud Services', 'Cloud Platforms'],
    qualifiesFor: ['Infrastructure', 'DevOps', 'Scalable Systems']
  },
  
  // Certifications
  {
    skill: 'AWS Certified Solutions Architect',
    aliases: ['AWS Solutions Architect', 'SAA-C03', 'SAA-C02', 'AWS SA'],
    qualifiesFor: ['Cloud Architecture', 'AWS', 'Cloud Computing']
  },
  {
    skill: 'AWS Certified Developer',
    aliases: ['AWS Developer Associate', 'DVA-C02', 'AWS Dev'],
    qualifiesFor: ['AWS', 'Cloud Development']
  },
  {
    skill: 'Microsoft Azure Fundamentals',
    aliases: ['AZ-900', 'Azure Fundamentals'],
    qualifiesFor: ['Azure', 'Cloud Computing']
  },
  {
    skill: 'Google Cloud Professional',
    aliases: ['GCP Professional', 'Google Cloud Certified'],
    qualifiesFor: ['GCP', 'Cloud Computing']
  },
  {
    skill: 'PMP',
  ...
  {
    skill: 'Leadership',
    aliases: ['Team Leadership', 'People Management', 'Team Management'],
    qualifiesFor: ['Management', 'People Skills', 'Soft Skills']
  },
  {
    skill: 'Communication',
    aliases: ['Communication Skills', 'Verbal Communication', 'Written Communication'],
    qualifiesFor: ['Interpersonal Skills', 'Soft Skills']
  },
  {
    skill: 'Problem Solving',
    aliases: ['Problem-Solving', 'Analytical Thinking', 'Critical Thinking'],
    qualifiesFor: ['Analytical Skills', 'Soft Skills']
  },
  {
    skill: 'Teamwork',
    aliases: ['Team Collaboration', 'Team Player', 'Collaboration'],
    qualifiesFor: ['Interpersonal Skills', 'Soft Skills']
  },
  {
    skill: 'Project Management',
    aliases: ['Project Coordination', 'Project Planning', 'Program Management'],
    qualifiesFor: ['Management', 'Planning', 'Soft Skills']
  }
]
...
export class SkillRegistry {
  private skillMap: Map<string, SkillRelationship>
  private aliasMap: Map<string, string> // alias -> canonical skill name
  
  constructor(skills: SkillRelationship[] = SOFTWARE_SKILLS_REGISTRY) {
   ...
   */
  findCanonicalSkill(skillName: string): string | null {
   ...
   */
  areAliases(skill1: string, skill2: string): boolean {
   ...
   */
  isChildOf(candidateSkill: string, requiredSkill: string): boolean {
    ...
    return skill.parent.some(parent => 
      this.areAliases(parent, requiredCanonical)
    )
  }
   ...
   */
  isParentOf(candidateSkill: string, requiredSkill: string): boolean {
    const canonical = this.findCanonicalSkill(candidateSkill)
    if (!canonical) return false
    ...
    return skill.children.some(child => 
      this.areAliases(child, requiredCanonical)
    )
  }
   ...
   */
  qualifiesFor(candidateSkill: string, requirement: string): boolean {
    const canonical = this.findCanonicalSkill(candidateSkill)
    if (!canonical) return false
    ...
    return skill.qualifiesFor.some(qual => 
      this.areAliases(qual, reqCanonical)
    )
  }
   ...
   */
  getRelatedSkills(skillName: string): {
    canonical: string
    parents: string[]
    children: string[]
    qualifiesFor: string[]
